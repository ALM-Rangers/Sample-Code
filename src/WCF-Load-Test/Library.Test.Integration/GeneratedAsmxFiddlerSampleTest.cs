...
namespace GeneratedAsmxFiddlerSampleTest
{
    ...
    public partial class GeneratedAsmxFiddlerSampleTestTests
    {
        ...
        [TestMethod()]
        public void GeneratedAsmxFiddlerSampleTest()
        {
            // 01/01/0001 00:00:00
        ...
        private string ProcessSimpleAsmxRequestWrapped()
        {
            ...
            _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_ProcessSimpleAsmxRequestWrapped");
            try
            {
            ...
            {
                _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_ProcessSimpleAsmxRequestWrapped");
            }
        }
        ...
        private GeneratedContractsAsmx.ProcessSimpleAsmxRequestBareResponse ProcessSimpleAsmxRequestBare()
        {
            ...
            _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_ProcessSimpleAsmxRequestBare");
            try
            {
            ...
            {
                _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_ProcessSimpleAsmxRequestBare");
            }
        }
        ...
        private string ProcessMultipleParametersWrapped()
        {
            ...
            _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_ProcessMultipleParametersWrapped");
            try
            {
            ...
            {
                _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_ProcessMultipleParametersWrapped");
            }
        }
        ...
        private GeneratedContractsAsmx.WithNullableIntResponse WithNullableInt()
        {
            ...
            _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_WithNullableInt");
            try
            {
            ...
            {
                _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_WithNullableInt");
            }
        }
        ...
        private int ScalarArray()
        {
            ...
            _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_ScalarArray");
            try
            {
            ...
            {
                _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_ScalarArray");
            }
        }
        ...
        private void XmlRequestMethod()
        {
            ...
            _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_XmlRequestMethod");
            try
            {
            ...
            {
                _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_XmlRequestMethod");
            }
        }
        ...
        private void CollectionMethod()
        {
            ...
            _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_CollectionMethod");
            try
            {
            ...
            {
                _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_CollectionMethod");
            }
        }
        ...
        private void ProcessShape()
        {
            ...
            _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_ProcessShape");
            try
            {
            ...
            {
                _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_ProcessShape");
            }
        }
        ...
        private System.Data.DataSet ProcessDataSet()
        {
            ...
            try
            {
                ...
                _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_ProcessDataSet");
                try
                {
                ...
                {
                    _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_ProcessDataSet");
                }
            }
            finally
            {
        ...
        private System.Data.DataSet ProcessDataSetWithMoreData()
        {
            ...
            try
            {
                ...
                _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_ProcessDataSetWithMoreData");
                try
                {
                ...
                {
                    _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_ProcessDataSetWithMoreData");
                }
            }
            finally
            {
        ...
        private void ProcessCompoundDataSet()
        {
            ...
            try
            {
                ...
                _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_ProcessCompoundDataSet");
                try
                {
                ...
                {
                    _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_ProcessCompoundDataSet");
                }
            }
            finally
            {
        ...
        private void ProcessTypedDataSet()
        {
            ...
            try
            {
                ...
                _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_ProcessTypedDataSet");
                try
                {
                ...
                {
                    _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_ProcessTypedDataSet");
                }
            }
            finally
            {
        ...
        private void ProcessCompoundTypedDataSet()
        {
            ...
            try
            {
                ...
                _testContext.BeginTimer("GeneratedAsmxFiddlerSampleTest_ProcessCompoundTypedDataSet");
                try
                {
                ...
                {
                    _testContext.EndTimer("GeneratedAsmxFiddlerSampleTest_ProcessCompoundTypedDataSet");
                }
            }
            finally
            {
